...
This reading list is an on-going personal challenge I'm about to start again.
The challenge is to digest one paper a day in the morning (a.k.a eating a paper
as breakfast). Over time I found that one can really really read a lot in
an hour. And it's a perfect way of starting a new day with some new interesting
knowledge.
