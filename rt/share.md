...
isSiteOnline("http://192.168.0.200:8000", function(found){
    if(found) {
        document.getElementById("shared-page").innerHTML = '<iframe width="560" height="315" src="http://192.168.0.200:8000" frameborder="0"></iframe>';
    }
    else {
